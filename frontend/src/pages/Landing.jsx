...
export default function Landing() {
  return (
    <div className="relative min-h-screen bg-white overflow-hidden font-sans text-slate-900">
      ...
      {/* 
        Inline styles for the strap animations.
        This keeps the component self-contained without needing tailwind.config.js edits.
      */}
      <style>
        {`
          @keyframes slideDown {
          ...
          .animate-strap-slow {
            ...
            transform: translateY(-100%); /* Keeps it hidden before the delay starts */
          }
        `}
      </style>
      ...
      {/* 
        ...
        Using the brand's red and blue. Positioned absolutely on the right.
      */}
      ...
      {/* 
        ...
        Flexbox used to anchor everything to the bottom left corner.
      */}
      <div className="absolute inset-0 flex flex-col justify-end items-start p-8 md:p-16 w-full md:w-3/4 lg:w-2/3 z-10">
        ...
        <h1 className="text-6xl md:text-8xl font-black mb-6 tracking-tighter uppercase leading-[0.9]">
          Modern <br />
          <span className="text-red-600">Trend</span> <br />
        ...
        <div className="flex flex-wrap gap-4 mb-12">
          ...
          <Link to="/blog" className="bg-white border-2 border-slate-200 hover:border-slate-900 text-slate-900 font-bold py-4 px-10 rounded-full transition-all">
            Read Our Blog
          </Link>
        </div>

        {/* Minimalist Contact Info */}
        <div className="flex flex-col sm:flex-row gap-6 text-sm font-bold text-slate-500">
